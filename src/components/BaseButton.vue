...
<template>
  ...
  >
    ...
    <IconSpinningIndicator
      class="absolute -translate-y-1/2 -translate-x-1/2 left-1/2 top-1/2 fill-black"
      v-if="loading"
    />
  </button>
</template>
